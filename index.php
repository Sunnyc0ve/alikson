    ...
    <main>
      ...
      <section class="AboutSection">
        <div class="About-Header">
          ...
          <p>
            ...
            высокотехнологичной и потребительской электроники, комплектующих и
            оборудования
          </p>
        </div>
      ...
      <section class="NewsSection">
        <div class="News-Header">
          <h2>НОВОСТИ</h2>
          <p>О нас пишут - и мы не останавливаемся на достигнутом</p>
        </div>
        <div class="News-Main">
          <div class="swiperN">
            <div class="swiper-wrapper">
        ...
        <div class="Projects-Main">
          ...
          <div class="Info" data="Service">
            ...
            <div class="Stats">
              <div>
                <h3>45+ ТЫС</h3>
                <p>единиц техники отремонтировано нашими специалистами</p>
              </div>
              <div>
                <h3>1 ГОД</h3>
          ...
          <div class="Info" data="Fond">
            ...
            <div class="Stats">
              <div>
                <h3>45+</h3>
                <p>Проектов реализовано <br> за 2 года</p>
              </div>
              <div>
                <h3>1%</h3>
